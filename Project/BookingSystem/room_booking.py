...
class BookingSystem:
    ...
    def book_room(self,index,start_time,booker_name,booking_type):
        self.daily_bookings.access_at_index(index).hourly_booking[start_time].booker_name = booker_name
        self.daily_bookings.access_at_index(index).hourly_booking[start_time].booker_name = booking_type
    def delete_booking(self,index,start_time):
        self.daily_bookings.access_at_index(index).hourly_booking[start_time].booker_name = "None"
        self.daily_bookings.access_at_index(index).hourly_booking[start_time].booker_name = "Vacant"
...
class HourlyBooking:
    ...
    def update_booking(self,booker_name, booking_type):
        self.booker_name = booker_name
        self.booking_type = booking_type
class DailyBooking:
    def __init__(self):
